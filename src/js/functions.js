...
(function(global, factory) {
  ...
  var vars = {
    ...
    get customCursor() {
      var value =
        this.elBody.getAttribute("data-custom-cursor") || options.cursor;
    ...
    get smoothScroll() {
      var value =
        this.elBody.getAttribute("data-smooth-scroll") || options.smoothScroll;
      return value == "true" || value === true ? true : false;
    },
    get isRTL() {
  ...
  var Core = (function() {
    return {
      ...
      scrollTo: function(
        ...
        if (
          ...
          typeof jQuery !== "undefined" &&
            typeof jQuery.easing["easeOutQuad"] !== "undefined"
        ) {
          jQuery("body,html")
            .stop(true)
            .animate(
          ...
          if (typeof window.scroll === "function" && smoothScroll) {
            ...
            var scrollToTop = function() {
              if (
                body.scrollTop > Number(offset) ||
                rootEl.scrollTop > Number(offset)
              ) {
                body.scrollTop -= 20;
                rootEl.scrollTop -= 20;
                ...
                var funcAvailable = new Promise(function(resolve) {
                  var int = setInterval(function() {
                    if (req.fn()) {
                      ...
                      var allTrue = Object.values(requireAll).every(function(
                        value
                      ) {
                        return value === true;
                      });
      ...
      topScrollOffset: function() {
        var headerHeight = 0;
        var pageMenuOffset =
          vars.elPageMenu?.querySelector("#page-menu-wrap")?.offsetHeight || 0;
        ...
        if (vars.elBody.classList.contains("is-expanded-menu")) {
          ...
          if (
            vars.elPageMenu?.classList.contains("dots-menu") ||
            !vars.elPageMenu?.classList.contains("sticky-page-menu")
          ) {
            pageMenuOffset = 0;
          }
        }
        ...
        Core.getVars.topScrollOffset =
          headerHeight + pageMenuOffset + options.scrollOffset;
      },
    };
  })();
