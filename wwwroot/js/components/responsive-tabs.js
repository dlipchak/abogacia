(function ($, window, undefined) {
  ...
  ResponsiveTabs.prototype.init = function () {
    ...
    this.$element.bind("tabs-load", function (e) {
      ...
      if (
        ...
        !(
          _this.options.startCollapsed === "accordion" &&
          _this.state === "accordion"
        )
      ) {
  ...
  ResponsiveTabs.prototype._loadElements = function () {
    ...
    $("li", $ul).each(function () {
      ...
      if (!isExcluded) {
        ...
        $panel = $(panelSelector);
        $accordionTab = $(_this.options.accordionTabElement).insertBefore(
          $panel
        );
        $accordionAnchor = $("<a></a>")
          .attr("href", panelSelector)
          .html($anchor.html())
          .appendTo($accordionTab);
  ...
  ResponsiveTabs.prototype._loadEvents = function () {
    ...
    for (var i = 0; i < this.tabs.length; i++) {
      ...
      this.tabs[i].anchor.on(
        _this.options.event,
        { tab: _this.tabs[i] },
        fActivate
      );
      this.tabs[i].accordionAnchor.on(
        _this.options.event,
        { tab: _this.tabs[i] },
        fActivate
      );
  ...
  ResponsiveTabs.prototype._setState = function (e) {
    ...
    if (this.state !== oldState) {
      ...
      if (
        oldState &&
        startCollapsedIsState &&
        this.options.startCollapsed !== this.state &&
        this._getCurrentTab() === undefined
      ) {
        // Get initial tab
   ...
   */
  ResponsiveTabs.prototype._openTab = function (
    e,
    oTab,
    closeCurrent,
    stopRotation
    ...
    oTab.tab
      .removeClass(_this.options.classes.stateDefault)
      .addClass(_this.options.classes.stateActive);
    oTab.accordionTab
      .removeClass(_this.options.classes.stateDefault)
      .addClass(_this.options.classes.stateActive);
    ...
    _this._doTransition(
      ...
      function () {
        ...
        if (
          _this.getState() === "accordion" &&
          _this.options.scrollToAccordion &&
          (!_this._isInView(oTab.accordionTab) ||
            _this.options.animation !== "default")
        ) {
          // Add offset element's height to scroll position
          scrollOffset =
            oTab.accordionTab.offset().top -
  ...
  ResponsiveTabs.prototype._closeTab = function (e, oTab) {
    ...
    if (oTab !== undefined) {
      ...
      oTab.tab
        .removeClass(_this.options.classes.stateActive)
        .addClass(_this.options.classes.stateDefault);
   ...
   */
  ResponsiveTabs.prototype._doTransition = function (
    panel,
    method,
    state,
    callback,
  ...
  ResponsiveTabs.prototype._isCollapisble = function () {
    return (
      (typeof this.options.collapsible === "boolean" &&
        this.options.collapsible) ||
      (typeof this.options.collapsible === "string" &&
  ...
  ResponsiveTabs.prototype._getNextTabRef = function (currentTabRef) {
    ...
    return this._getTab(nextTabRef).disabled
      ? this._getNextTabRef(nextTabRef)
      : nextTabRef;
  };
  ...
  ResponsiveTabs.prototype._getPreviousTabRef = function () {
    return this._getCurrentTabRef() === 0
      ? this.tabs.length - 1
  ...
  $.fn.responsiveTabs = function (options) {
    ...
    if (options === undefined || typeof options === "object") {
      ...
      if (
        instance instanceof ResponsiveTabs &&
