...
!function(t){"use strict";function e(e,s){this.element=t(e),this.settings=t.extend({},n,s),this._defaults=n,this._init()}var s="Morphext",n={animation:"bounceIn",separator:",",speed:2e3,complete:t.noop};e.prototype={_init:function(){var e=this;this.phrases=[],this.element.addClass("morphext"),t.each(this.element.text().split(this.settings.separator),(function(s,n){e.phrases.push(t.trim(n))})),this.index=-1,this.animate(),this.start()},animate:function(){this.index=++this.index%this.phrases.length,this.element[0].innerHTML='<span class="animated '+this.settings.animation+'">'+this.phrases[this.index]+"</span>",t.isFunction(this.settings.complete)&&this.settings.complete.call(this)},start:function(){var t=this;this._interval=setInterval((function(){t.animate()}),this.settings.speed)},stop:function(){this._interval=clearInterval(this._interval)}},t.fn[s]=function(n){return this.each((function(){t.data(this,"plugin_"+s)||t.data(this,"plugin_"+s,new e(this,n))}))}}(jQuery),
/*!
 *
